      ...
      <main className="flex-1">
        ...
        <section className="relative">
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4 md:px-6">
            <h1 className="text-3xl font-bold tracking-tighter text-white sm:text-5xl md:text-6xl">Văn Hóa Miền Bắc</h1>
          ...
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Miền Bắc Việt Nam là cái nôi của nền văn minh Việt, nơi lưu giữ những giá trị văn hóa truyền thống lâu
                đời nhất của dân tộc. Với lịch sử hàng nghìn năm dựng nước và giữ nước, miền Bắc đã hình thành nên một
                nền văn hóa đặc sắc, đa dạng và phong phú.
              </p>
              <p className="text-muted-foreground mb-4">
                Văn hóa miền Bắc mang đậm tính nông nghiệp lúa nước, với những làng quê truyền thống, những phong tục
                tập quán gắn liền với mùa màng và đời sống cộng đồng. Đây cũng là nơi lưu giữ nhiều di sản văn hóa vật
                thể và phi vật thể quý giá của dân tộc.
              </p>
              <p className="text-muted-foreground">
                Người miền Bắc nổi tiếng với tính cách cần cù, chịu khó, tiết kiệm và trọng lễ nghĩa. Văn hóa ứng xử,
                giao tiếp của người miền Bắc thường mang tính truyền thống, coi trọng lễ nghi, phép tắc và quan hệ dòng
                họ.
              </p>
            </div>
            <div className="relative h-[400px] rounded-lg overflow-hidden">
              <Image src={VHMienBac} alt="Văn hóa miền Bắc" fill className="object-cover" />
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <Tabs defaultValue="festivals" className="w-full">
              <div className="flex justify-center mb-8">
                <TabsList>
                  <TabsTrigger value="festivals">Lễ hội truyền thống</TabsTrigger>
                  <TabsTrigger value="cuisine">Ẩm thực</TabsTrigger>
                  <TabsTrigger value="heritage">Di sản văn hóa</TabsTrigger>
                  <TabsTrigger value="crafts">Làng nghề truyền thống</TabsTrigger>
                </TabsList>
              </div>
        ...
        <section className="container py-12 md:py-16 lg:py-20">
          <div className="text-center mb-12">
            ...
            <p className="max-w-[700px] mx-auto text-muted-foreground">
              Khám phá những làn điệu dân ca và nghệ thuật truyền thống đặc sắc của miền Bắc
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Quan họ là loại hình dân ca đặc sắc của vùng Kinh Bắc, được UNESCO công nhận là Di sản văn hóa phi vật
                  thể của nhân loại. Quan họ thường được hát đối đáp giữa nam và nữ, với những làn điệu ngọt ngào, sâu
                  lắng.
                </p>
                <div className="relative h-[200px] rounded-lg overflow-hidden">
                  <Image src="/images/quan-ho.png" alt="Quan họ Bắc Ninh" fill className="object-cover" />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Nghệ thuật sân khấu dân gian truyền thống</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Chèo là loại hình nghệ thuật sân khấu dân gian truyền thống của Việt Nam, đặc biệt phổ biến ở miền
                  Bắc. Chèo kết hợp nhiều yếu tố nghệ thuật như ca, múa, nhạc và kịch, thường phản ánh đời sống và tâm
                  tư của người dân lao động.
                </p>
                <div className="relative h-[200px] rounded-lg overflow-hidden">
                  <Image src="/images/hat-cheo.png" alt="Hát Chèo" fill className="object-cover" />
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="bg-primary/10 py-12 md:py-16 lg:py-20">
          <div className="container text-center">
            ...
            <p className="max-w-[700px] mx-auto text-muted-foreground mb-8">
              Hãy đến và trải nghiệm nét đẹp văn hóa đặc sắc của vùng đất ngàn năm văn hiến
            </p>
...
const festivals = [
  ...
  },
  {
    ...
    description: "Lễ hội lớn nhất cả nước tưởng nhớ các Vua Hùng - những người đã có công dựng nước và giữ nước.",
...
const crafts = [
  {
    ...
    location: "Hà Nội",
    description: "Làng nghề gốm sứ truyền thống với lịch sử hơn 700 năm, nổi tiếng với các sản phẩm gốm sứ tinh xảo.",
    image: "/images/bat-trang.png",
  },
  {
    name: "Làng lụa Vạn Phúc",
    location: "Hà Nội",
    description: "Làng nghề dệt lụa truyền thống với các sản phẩm lụa cao cấp được dệt và thêu thủ công.",
    image: "/images/van-phuc.png",
  },
  {
    name: "Làng tranh Đông Hồ",
    location: "Bắc Ninh",
    description: "Làng nghề làm tranh dân gian truyền thống, nổi tiếng với các bức tranh in màu trên giấy dó.",
